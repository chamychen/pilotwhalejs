...
import { EditControlModel, RowEditMode } from './mixins/control'
    ...
    genFooters(props: DataProps) {
      const data = {
        props: {
          ...
          itemsPerPageText: '$vuetifyx.dataTable.itemsPerPageText',
          ...this.footerProps
        },
        on: {

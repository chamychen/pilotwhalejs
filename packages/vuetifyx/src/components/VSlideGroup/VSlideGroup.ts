...
>(
  ...
  computed: {
    ...
    isMobile (): boolean {
      return this.$vuetifyx.breakpoint.width < this.mobileBreakPoint
    }
  },
  ...
  methods: {
    ...
    genIcon (location: 'prev' | 'next'): VNode | null {
      ...
      if (this.$vuetifyx.rtl && location === 'prev') {
        icon = 'next'
      } else if (this.$vuetifyx.rtl && location === 'next') {
        icon = 'prev'
      }
    ...
    newOffset /* istanbul ignore next */ (direction: 'prev' | 'next') {
      ...
      return this.$vuetifyx.rtl ? -min : min
    },

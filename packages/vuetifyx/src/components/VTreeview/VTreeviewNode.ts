...
export const VTreeviewNodeProps = {
  ...
  indeterminateIcon: {
    type: String,
    default: '$vuetifyx.icons.checkboxIndeterminate'
  },
  onIcon: {
    type: String,
    default: '$vuetifyx.icons.checkboxOn'
  },
  offIcon: {
    type: String,
    default: '$vuetifyx.icons.checkboxOff'
  },
  expandIcon: {
    type: String,
    default: '$vuetifyx.icons.subgroup'
  },
  loadingIcon: {
    type: String,
    default: '$vuetifyx.icons.loading'
  },
  itemKey: {
    type: String,
    default: 'id'

...
export default baseMixins.extend<options>().extend({
  ...
  props: {
    appendIcon: {
      type: String,
      default: '$vuetifyx.icons.dropdown'
    },
    ...
    listData(): object {
      ...
      return {
        ...
        props: {
          ...
          noDataText: this.$vuetifyx.lang.t(this.noDataText),
  ...
  methods: {
    ...
    genChipSelection(item: object, index: number) {
      ...
      return this.$createElement(
        VChip,
        {
          ...
          // update by chamy
          key: `${this.$vnode.key + this.g}_chips${index}`
        },
        this.getText(item)
      )
    },
    ...
    onKeyDown(e: KeyboardEvent) {
      ...
      if (!this.readonly && !this.isMenuActive && [keyCodes.enter, keyCodes.space, keyCodes.up, keyCodes.down].includes(keyCode)) {
        this.activateMenu()
      }
    ...
    onMouseUp(e: MouseEvent) {
      if (this.hasMouseDown) {
        ...
        if (this.isMenuActive && appendInner && (appendInner === e.target || (appendInner as { [key: string]: any }).contains(e.target))) {
    ...
    onTabDown(e: KeyboardEvent) {
      ...
      if (listTile && listTile.className.indexOf('v-list-item--highlighted') > -1 && this.isMenuActive && menuIndex > -1) {
        e.preventDefault()
        e.stopPropagation()

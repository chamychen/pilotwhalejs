...
describe('AppBar.ts', () => {
  ...
  it('should calculate paddings ', () => {
    ...
    wrapper.vm.$vuetifyx.application.left = 42
    wrapper.vm.$vuetifyx.application.right = 84
  ...
  it('should set margin top', () => {
    ...
    Vue.set(wrapper.vm.$vuetifyx.application, 'bar', 24)
  ...
  // https://github.com/vuetifyjs/vuetifyx/issues/4985

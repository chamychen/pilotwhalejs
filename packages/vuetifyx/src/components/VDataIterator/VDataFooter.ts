...
export default Vue.extend({
  ...
  props: {
    ...
    prevIcon: {
      type: String,
      default: '$vuetifyx.icons.prev'
    },
    nextIcon: {
      type: String,
      default: '$vuetifyx.icons.next'
    },
    firstIcon: {
      type: String,
      default: '$vuetifyx.icons.first'
    },
    lastIcon: {
      type: String,
      default: '$vuetifyx.icons.last'
    },
    itemsPerPageText: {
      type: String,
      default: '$vuetifyx.dataFooter.itemsPerPageText'
    },
    itemsPerPageAllText: {
      type: String,
      default: '$vuetifyx.dataFooter.itemsPerPageAll'
    },
  ...
  computed: {
    ...
    computedItemsPerPageOptions (): any[] {
      ...
      return itemsPerPageOptions.map(value => ({
        text: value === -1 ? this.$vuetifyx.lang.t(this.itemsPerPageAllText) : String(value), value
      }))
    }
  },
  ...
  methods: {
    ...
    genItemsPerPageSelect () {
      return this.$createElement('div', {
        ...
        this.$vuetifyx.lang.t(this.itemsPerPageText),
    ...
    genIcons () {
      ...
      before.push(this.genIcon(
        this.onPreviousPage,
        this.options.page === 1,
        this.$vuetifyx.lang.t('$vuetifyx.dataFooter.prevPage'),
        this.$vuetifyx.rtl ? this.nextIcon : this.prevIcon
      ))

      after.push(this.genIcon(
        this.onNextPage,
        this.disableNextPageIcon,
        this.$vuetifyx.lang.t('$vuetifyx.dataFooter.nextPage'),
        this.$vuetifyx.rtl ? this.prevIcon : this.nextIcon
      ))
      ...
      if (this.showFirstLastPage) {
        before.unshift(this.genIcon(
          this.onFirstPage,
          this.options.page === 1,
          this.$vuetifyx.lang.t('$vuetifyx.dataFooter.firstPage'),
          this.$vuetifyx.rtl ? this.lastIcon : this.firstIcon
        ))

        after.push(this.genIcon(
          this.onLastPage,
          this.options.page === this.pagination.pageCount || this.options.itemsPerPage === -1,
          this.$vuetifyx.lang.t('$vuetifyx.dataFooter.lastPage'),
          this.$vuetifyx.rtl ? this.firstIcon : this.lastIcon
        ))
      }

...
export default VWindow.extend({
  ...
  props: {
    ...
    delimiterIcon: {
      type: String,
      default: '$vuetifyx.icons.delimiter'
    },
    height: {
      type: [Number, String],
      default: 500
  ...
  methods: {
    ...
    genIcon (
      ...
      return this.$createElement('div', {
        ...
        this.$createElement(VBtn, {
          ...
          attrs: {
            'aria-label': this.$vuetifyx.lang.t(`$vuetifyx.carousel.${direction}`)
          },
          on: {
            click: () => {
    ...
    genIcons (): VNode[] {
      ...
      const prevIcon = this.$vuetifyx.rtl
        ? this.nextIcon
        : this.prevIcon
      ...
      const nextIcon = this.$vuetifyx.rtl
        ? this.prevIcon
        : this.nextIcon

...
export default mixins<
  options &
    ...
    ExtractVue<[typeof Colorable, typeof Themeable, typeof Validatable]>
...
>(
  ...
  beforeCreate() {
    ...
    // https://github.com/vuetifyjs/vuetifyx/issues/4752
  ...
  methods: {
    ...
    genIcon(type: string, cb?: (e: Event) => void, shouldDeprecate = true) {

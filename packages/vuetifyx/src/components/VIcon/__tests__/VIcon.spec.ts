...
describe('VIcon', () => {
  ...
  describe('for global icon', () => {
    ...
    it('should render MD left icon from $vuetifyx.icons.checkboxOn', () => {
      const wrapper = mountFunction({}, '$vuetifyx.icons.checkboxOn')

      expect(wrapper.text()).toBe('check_box')
      expect(wrapper.element.className).toBe('v-icon material-icons theme--light')
    })

    it('should render MD left icon from $vuetifyx.icons.prev', () => {
      const wrapper = mountFunction({}, '$vuetifyx.icons.prev')
  ...
  describe('for component icon', () => {
    ...
    it('should render component', () => {
      const wrapper = mountFunction({}, '$vuetifyx.icons.testIcon')
    ...
    it('should render a colored component', () => {
      const wrapper = mountFunction({ props: { color: 'green lighten-1' } }, '$vuetifyx.icons.testIcon')
    ...
    it('should render a disabled component', () => {
      const wrapper = mountFunction({ props: { disabled: true } }, '$vuetifyx.icons.testIcon')
    ...
    it('should render a left aligned component', () => {
      const wrapper = mountFunction({ props: { left: true } }, '$vuetifyx.icons.testIcon')

      expect(wrapper.element.classList).toContain('v-icon--left')
    })

    it('should render a right aligned component', () => {
      const wrapper = mountFunction({ props: { right: true } }, '$vuetifyx.icons.testIcon')
    ...
    it('should be a link', () => {
      ...
      const wrapper = mountFunction({ on: { click: clickHandler } }, '$vuetifyx.icons.testIcon')

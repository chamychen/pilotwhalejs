...
export default mixins<
  options &
    ...
    ExtractVue<[typeof VInput, typeof Maskable, typeof Loadable]>
  /* eslint-enable indent */
>(VInput, Maskable, Loadable).extend({
  name: 'v-text-field',
  ...
  computed: {
    ...
    isEnclosed() {
      return this.box || this.isSolo || this.outline || this.fullWidth
    },
    isLabelActive() {
    ...
    labelPosition() {
      ...
      return !this.$vuetifyx.rtl !== !this.reverse
        ? {
            left: 'auto',
            right: offset
          }

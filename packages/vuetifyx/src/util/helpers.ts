...
import { VuetifyIcon } from 'vuetifyx/types/services/icons'
...
const ICONS_PREFIX = '$vuetifyx.'

// This remaps internal names like '$vuetifyx.icons.cancel'
...
export function remapInternalIcon (vm: Vue, iconName: string): VuetifyIcon {
  ...
  const iconPath = `$vuetifyx.icons.values.${iconName.split('.').pop()}`

  // Now look up icon indirection name,
  // e.g. '$vuetifyx.icons.values.cancel'

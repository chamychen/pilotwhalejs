...
import {
  ...
  VuetifyThemes,
  VuetifyThemeVariant
} from 'vuetifyx/types/services/theme'
...
export class Theme extends Service {
  ...
  public init (ssrContext?: any): void {
    ...
    if (this.ssr) {
      ...
      ssrContext.head += `<style type="text/css" id="vuetifyx-theme-stylesheet"${nonce}>${this.generatedStyles}</style>`
  ...
  private checkStyleElement (): boolean {
    ...
    this.styleEl = document.getElementById('vuetifyx-theme-stylesheet') as HTMLStyleElement
  ...
  private genStyleElement (): void {
    ...
    this.styleEl.id = 'vuetifyx-theme-stylesheet'
